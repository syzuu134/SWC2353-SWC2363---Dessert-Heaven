...
if(isset($_POST['update_update_btn'])){
   ...
   $update_quantity_query = mysqli_query($conn, "UPDATE `cart_items` SET quantity = '$update_value' WHERE id = '$update_id'");
...
if(isset($_GET['remove'])){
   ...
   mysqli_query($conn, "DELETE FROM `cart_items` WHERE id = '$remove_id'");
   header('location:cart.php');
};
   ...
   <table>
      ...
      <tbody>
         ...
         <tr class="table-bottom">
            <td><a href="mainProduct.php" class="option-btn" style="margin-top: 0;">continue shopping</a></td>
